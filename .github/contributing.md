...
Report bugs, ask questions, and request features using [GitHub Issues](https://github.com/cferdinandi/houdini/issues).
...
2. [A reduced test case.](https://css-tricks.com/reduced-test-cases/)
	...
	- You can create one by [forking this CodePen](https://codepen.io/cferdinandi/pen/mQjMLP).
